...
#define F_CPU 16000000UL // I added based on warning
#include <avr/io.h>
...
#define LCD_EN_PIN    PB3 // PORTB3

// for data/commands
#define LCD_D_PORT    PORTD  //digital pins 
#define LCD_D_DDR     DDRD
#define LCD_D7_PIN    PD2    //PORTD2
#define LCD_D6_PIN    PD3    //PORTD3
